...
<%
    String dateParam = (String) request.getAttribute("date");
    String checkinDate = "";
    String checkoutDate = "";
    if (dateParam != null && dateParam.contains("~")) {
...
<!-- 									호텔 이름 -->
									<div class="css-9e4tkg--ProductInfoSummary--Container e1m7creq3">
										<div class="css-n2xyg7--ProductInfoSummary--ImageWrapper e1m7creq2">
											<img src="https://pix8.agoda.net/hotelImages/32784632/0/d2ce9ed3b5ae0b6007a43fef219d4f49.jpeg?ce=0&amp;s=1000x" alt="상품 이미지" class="css-170w93a--ProductInfoSummary--Image e1m7creq1">
										</div>
										<h3 class="css-1hgeeeb--ProductInfoSummary--Title e1m7creq0">${hotel.name}</h3>
									</div>
<!-- 									체크인 -->
									...
									<ul class="css-v6wk68--PriceList--OptionWrapper ew0r5g20">
										<li class="css-1xtyir3--OptionInfoList--Option e1fd4fa03">
											<div class="css-81epwr--OptionInfoList--OptionText e1fd4fa01">
												<span class="css-16q01t6--OptionInfoList--OptionName e1fd4fa02">${room.title}</span>
											</div>
											<div class="css-mnnvnj--OptionInfoList--OptionPrice e1fd4fa00">${formattedDiscountedPrice}원</div>
										</li>
										<li class="css-qcgeyu--ExtraInfoList--Option el8p7f63">
											<div class="css-1gf28m5--ExtraInfoList--OptionText el8p7f61">
												<span class="css-qb575q--ExtraInfoList--OptionName el8p7f62">총 숙박일</span>
											</div>
											<div class="css-17r2s3v--ExtraInfoList--OptionPrice el8p7f60">총 ${totalNights}박</div>
										</li>
									</ul>
									<div class="css-71xvha--PriceTotal--Container e1o8jsxo4">
										<div class="css-wdcz2a--PriceTotal--TotalPriceWrapper e1o8jsxo3">
											<div class="css-u0gcr6--PriceTotal--TotalPriceText e1o8jsxo2">총 상품 금액</div>
										    <strong class="css-1qt89sm--PriceTotal--TotalPriceNumber e1o8jsxo1">
										        <fmt:formatNumber value="${discountedPrice * totalNights}" type="number" pattern="#,###"/>원
										    </strong>
										</div>
									</div>
								</div>
										...
										<div class="css-1jsagqa--ReservationPerson--Container e1eynx4r2">
											<div class="css-cv06j6--EditForm--Container e1rcmy85">
												<div class="css-9yldiq--EditForm--KoreanNameWrapper e1rcmy84">
													<span class="css-119aw1b--EditForm--KoreanName--getEllipsisStyle--getEllipsisStyle e1rcmy83">${person.last_name} ${person.first_name}</span>
													<img class="css-labkkb" src="https://dffoxz5he03rp.cloudfront.net/icons/ic_select_arrow_gray_1000.svg" alt="icon">
												</div>
												<div class="css-1qn2m1l--Email--Info--getEllipsisStyle--getEllipsisStyle e1tt4p4k0">${user.email}</div>
												<div class="css-19x6daw--KorName--Info--getEllipsisStyle--getEllipsisStyle e1apmuge0">${person.last_name} ${person.first_name}</div>
												<div class="css-1d7kmj6--Phone--Info e1qr2bi0">${person.phone}</div>
					            ...
					            <div class="css-1dc0kte--SectionContainer--Body exjt3m70">
					                ...
					                <div class="css-1ab299y--PaymentInfo--Wrapper e14vm5k10">
					                    <div class="css-1b76hqd--ProductNoticeInfo--Wrapper e17edfi26">
					                        <span class="css-1t882oi--ProductNoticeInfo--Text--ProductNoticeInfo--Button e17edfi24">숙소에 대해 알아두실 사항</span>
					                    ...
					                    <div class="css-rzod1--Term--Container er2oaqx0">
					                        ...
					                        <div class="css-1rn2pqw--RefundPolicy--Container e1g30hl80">
					                            ...
					                            <div class="css-93wur2--RefundPolicy--Text e1g30hl82">
											        <p class="css-1vct4yp--RenderMultiLineText--Line e4rbi9y0">${refundPolicyDate}까지 취소 <br>(한국시간) : 전액 환불</p>
											        <p class="css-1vct4yp--RenderMultiLineText--Line e4rbi9y0">${checkInDateString} 이후 취소 <br>(한국시간) : 환불 불가</p>
					                            </div>
					                        </div>
					                    </div>
					                </div>
					            ...
					            <span role="button" class="css-w0pi5v">
							        <button type="button" class="mrt-button css-jgs6n" id="purchaseButton">
							            <span class="css-1s4v6ia" id="purchaseButtonText">
							                <fmt:formatNumber value="${discountedPrice * totalNights}" type="number" pattern="#,###"/>원 결제하기
							            </span>
							        </button>
					            </span>
					        </div>
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
	    // "모두 사용" 버튼 클릭 이벤트
	    document.getElementById('useAllPoints').addEventListener('click', function() {
	    ...
	    function updateFinalPrice() {
	        const pointsToUse = parseInt(document.getElementById('pointsToUse').value, 10) || 0;
	        ...
	        const originalTotalPrice = discountedPrice * totalNights;
	        const finalPrice = originalTotalPrice - pointsToUse;
	        finalPriceElement.textContent = new Intl.NumberFormat().format(finalPrice) + '원';
	
	        // Update purchase button text
	        document.getElementById('purchaseButtonText').textContent = new Intl.NumberFormat().format(finalPrice) + '원 결제하기';
	    }
	    ...
	    document.getElementById('purchaseButton').addEventListener('click', function() {
	        ...
	        const checkInDate = urlParams.get('date').split('~')[0].trim();
