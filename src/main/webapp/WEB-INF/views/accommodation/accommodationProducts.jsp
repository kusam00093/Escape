...
<link rel="stylesheet" href="/css/accommodation/accommodationProducts.css" />
...
$(document).ready(function() {
    function fetchHotels() {
        ...
        var minPrice = parseInt($("#min-amount").text().replace('원', '').trim()) || 0;
        var maxPrice = parseInt($("#max-amount").text().replace('원', '').replace('+', '').trim()) || 500000;
        var ratings = [];
        $('input[name="rating"]:checked').each(function() {
            ratings.push(parseInt($(this).val()));
        });

        var minRating = Math.min(...ratings);
        var maxRating = Math.max(...ratings);

        $.ajax({
            url: '/AccommodationApi/hotelsFiltering',
            type: 'GET',
            data: {
                orderBy: orderBy,
                minPrice: minPrice,
    ...
    function renderHotels(hotels) {
        ...
        hotels.forEach(function(hotel, index) {
            var lowestPrice = hotel.LOWEST_PRICE;
            var discountRate = hotel.DISCOUNT_RATE;
            var discountAmount = hotel.DISCOUNT_AMOUNT;
            var discountedPrice = discountRate > 0 ? lowestPrice - (lowestPrice * discountRate / 100) : lowestPrice - discountAmount;

            var formattedLowestPrice = new Intl.NumberFormat().format(lowestPrice) + '원';
            var formattedDiscountedPrice = new Intl.NumberFormat().format(discountedPrice) + '원/박';

            var hotelHTML = `
                <div data-index="${index}" class="hotel">
                        ...
                        <div class="css-jk17ry erljagq0">
                            <div class="thumbnail css-0 e6oouci0" aria-hidden="true" tabindex="-1">
                                <div aria-hidden="true" role="presentation" class="css-1l5ilpc e6oouci1">
                                    <img alt="상품 썸네일" loading="lazy" decoding="async" data-nimg="fill" class="css-g81ghj e6oouci2" src="${hotel.IMAGES.split(',')[0]}" style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                                </div>
                            </div>
                                ...
                                <div class="mb-half-3 css-p58936 erljagq2">
                                    <div class="css-1iwf967 erljagq3">
                                        <div class="css-tjdujr edi3p4g1">
                                            ...
                                            <h3 class="edi3p4g2 css-16kmqln">${hotel.ADDRESS}</h3>
                                        ...
                                        <div class="css-dl3kio e1lavvxd0">
                                            <ul class="css-qzcwn1 e1lavvxd1">
                                                <li class="css-5i1dh6 e1lavvxd2"> 
                                                    ...
                                                    <span class="e1lavvxd3 css-1e4wxax">${formattedLowestPrice}</span>
                                                </li>
                                                <li class="css-5i1dh6 e1lavvxd2">
                                                    ...
                                                    <span>
                                                        <div class="css-5i1dh6 e1lavvxd2" style="justify-content: flex-end;">
                                                            ...
                                                            <span class="css-19kftx2" style="color: rgb(250, 91, 74);">${formattedDiscountedPrice}</span>
                                                        </div>
    ...
    $('input[name="orderBy"], input[name="rating"], #resetFilters').change(function() {
        fetchHotels();
    });

    $('#resetFilters').click(function() {
        $('input[name="rating"]').prop('checked', false);
        $('input[name="orderBy"]').prop('checked', false);
        $("#min-amount").text("0원");
        $("#max-amount").text("500,000원+");
        fetchHotels();
    });
        ...
        <aside class="mainBody_aside_filter">
            ...
            <div class="filter_bigBox">
                ...
                <div role="checkbox" class="css-ls5l09 e1iur2ag0">
                    <label class="css-1dkg27r css-19bfog6" for="1성급 이하">
                        <div class="css-1ert3cq">
                            <div class="css-1xxrznb">
                                <input id="1성급 이하" type="checkbox" name="rating" class="css-12a4kog" value="1">
                    ...
                    <label class="css-1dkg27r css-19bfog6" for="2점">
                        <div class="css-1ert3cq">
                            <div class="css-1xxrznb">
                                <input id="1성급 이하" type="checkbox" name="rating" class="css-12a4kog" value="1">
                                <div class="css-l0jxtc"></div>
                    ...
                    <label class="css-1dkg27r css-19bfog6" for="3점">
                        <div class="css-1ert3cq">
                            <div class="css-1xxrznb">
                                <input id="1성급 이하" type="checkbox" name="rating" class="css-12a4kog" value="1">
                                <div class="css-l0jxtc"></div>
                    ...
                    <label class="css-1dkg27r css-19bfog6" for="4점">
                        <div class="css-1ert3cq">
                            <div class="css-1xxrznb">
                                <input id="1성급 이하" type="checkbox" name="rating" class="css-12a4kog" value="1">
                                <div class="css-l0jxtc"></div>
                    ...
                    <label class="css-1dkg27r css-19bfog6" for="점">
                        <div class="css-1ert3cq">
                            <div class="css-1xxrznb">
                                <input id="1성급 이하" type="checkbox" name="rating" class="css-12a4kog" value="1">
                                <div class="css-l0jxtc"></div>
            ...
            <div class="css-j7qwjs e1kcc1jp0">
                ...
                <div role="radiogroup" class="css-ls5l09 e1iur2ag0">
                    <label class="css-1dkg27r css-19bfog6" for="북마크 갯수 순">
                        <div class="css-1ert3cq">
                            <div class="css-75qw4d">
                                <input id="북마크 갯수 순" type="radio" name="orderBy" class="css-12a4kog" value="bookmark_count">
                    ...
                    <label class="css-1dkg27r css-19bfog6" for="낮은 가격순">
                        <div class="css-1ert3cq">
                            <div class="css-75qw4d">
                                <input id="낮은 가격순" type="radio" name="orderBy" class="css-12a4kog" value="price_asc">
                                <div class="css-3wrzi8"></div>
                                <div class="css-1dxdjkp"></div>
                            </div>
                        </div>
                    ...
                    <label class="css-1dkg27r css-19bfog6" for="높은 가격순">
                        <div class="css-1ert3cq">
                            <div class="css-75qw4d">
                                <input id="높은 가격순" type="radio" name="orderBy" class="css-12a4kog" value="price_desc">
                                <div class="css-3wrzi8"></div>
                                <div class="css-1dxdjkp"></div>
                            </div>
                        </div>
                    ...
                    <label class="css-1dkg27r css-19bfog6" for="최신순">
                        <div class="css-1ert3cq">
                            <div class="css-75qw4d">
                                <input id="최신순" type="radio" name="orderBy" class="css-12a4kog" value="latest">
                                <div class="css-3wrzi8"></div>
                                <div class="css-1dxdjkp"></div>
                            </div>
                        </div>
                        <div color="" class="css-6mvyws">
                            <span class="e1iur2ag1 css-gnwfui">최신순</span>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <button id="resetFilters" shape="pill" class="css-y8aj3r css-d006cr" style="position: absolute; width: 120px; margin-top: 10px;">
...
<script src="/js/accommodation/accommodationProducts.js">
</script>	 
</body>
