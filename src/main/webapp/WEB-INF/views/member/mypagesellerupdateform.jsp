...
<body>
    <div class="register-container">
        <h2>Seller 회원정보 수정하기</h2>
        <form action="/mypageSellerUpdate" method="post" onsubmit="validateForm(event)">
        ...
        <input type="hidden" id="seller_idx" name="seller_idx" value="${seller.seller_idx}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="cnum" name="cnum" value="${seller.cnum}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="logo" name="logo" value="${seller.logo}">
            </div>
